...
\usepackage[a4paper,lmargin=1.5cm,rmargin=1.5cm]{geometry}
\usepackage{color}
\usepackage{bookmark}
\usepackage{siunitx}
...
%
% pour regrouper exercices et solutions dans un seul fichier et
% les afficher tantôt ensemble, tantôt séparément
%
%\usepackage{exsol}

%
% pour avoir des références sur internet et un pdf cliquable
%
\usepackage{hyperref}
\usepackage[
    type={CC},
...
\rhead{énergie, oscillateur et ondes}
...
%\includeonly{
%COURS_00-exercices-test.tex
%COURS_01-Energie-travail-puissance-rendement
...
%\include{COURS_00-exercices-test.tex}
\include{COURS_01-Energie-travail-puissance-rendement}
